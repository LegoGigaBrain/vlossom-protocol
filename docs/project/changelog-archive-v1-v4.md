# Changelog Archive (V1.2.0 - V4.0.1)

This file contains archived changelog entries for versions 1.2.0 through 4.0.1.

For current changelog entries (V5.0.0+), see [changelog.md](./changelog.md).
