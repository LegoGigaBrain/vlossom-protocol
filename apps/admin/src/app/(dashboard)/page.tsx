...
// Dashboard stats data (would come from API)
const stats = [
  {
    title: "Total Users",
    value: "2,847",
...
const quickActions = [
  {
    title: "Manage Users",
    description: "View, edit, or freeze user accounts",
    href: "/users",
    icon: (
  ...
  },
  {
    ...
    description: "Track in-progress services",
    href: "/sessions",
    icon: (
